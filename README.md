...
My engineering journey started in web development — building with **HTML, CSS, JavaScript, Vuejs and React.js** — before I went fully all-in on mobile with Flutter. That web foundation gave me a strong eye for UI composition and component design, but today **mobile is my world and Flutter is my craft**.
